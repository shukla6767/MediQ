...
export default function AdminHospitalsPage() {
  ...
  const [formData, setFormData] = useState({ name: "", address: "", phone: "", email: "", totalBeds: "" });
  ...
  const openCreate = () => {
    setFormData({ name: "", address: "", phone: "", email: "", totalBeds: "" });
    setEditingHospital(null);
    setIsCreateOpen(true);
  };

  const openEdit = (hospital) => {
    setFormData({ name: hospital.name, address: hospital.address, phone: hospital.phone, email: hospital.email, totalBeds: hospital.totalBeds || "" });
